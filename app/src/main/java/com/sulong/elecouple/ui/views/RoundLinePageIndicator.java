...
public class RoundLinePageIndicator extends View implements PageIndicator {
    ...
    public void onRestoreInstanceState(Parcelable state) {
        RoundLinePageIndicator.SavedState savedState = (RoundLinePageIndicator.SavedState)state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        RoundLinePageIndicator.SavedState savedState = new RoundLinePageIndicator.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            @Override
            public RoundLinePageIndicator.SavedState createFromParcel(Parcel in) {
                return new RoundLinePageIndicator.SavedState(in);
            }

            @Override
            public RoundLinePageIndicator.SavedState[] newArray(int size) {
                return new RoundLinePageIndicator.SavedState[size];
            }
        };
    }
