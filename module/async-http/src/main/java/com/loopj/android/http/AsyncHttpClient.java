...
public class AsyncHttpClient {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(String url, RequestParams params, IResponseHandler responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Context context, String url, IResponseHandler responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Context context, String url, RequestParams params, IResponseHandler responseHandler) {
        return sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, getWrapperResponseHandler(responseHandler), context);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Context context, String url, Header[] headers, RequestParams params, IResponseHandler responseHandler) {
        HttpUriRequest request = new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params));
        if (headers != null) request.setHeaders(headers);
        return sendRequest(httpClient, httpContext, request, null, getWrapperResponseHandler(responseHandler), context);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle get(Context context, String url, HttpEntity entity, String contentType, IResponseHandler responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpGet(URI.create(url).normalize()), entity), contentType, getWrapperResponseHandler(responseHandler), context);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(String url, IResponseHandler responseHandler) {
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(String url, RequestParams params, IResponseHandler responseHandler) {
    ...
    public RequestHandle post(Context context, String url, RequestParams params, IResponseHandler responseHandler) {
        AsyncHttpResponseHandler handler = getWrapperResponseHandler(responseHandler);
        return post(context, url, paramsToEntity(params, handler), null, handler);
    }
     ...
     * @return RequestHandle of future request process
     */
    public RequestHandle post(Context context, String url, HttpEntity entity, String contentType, IResponseHandler responseHandler) {
        AsyncHttpResponseHandler handler = getWrapperResponseHandler(responseHandler);
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPost(getURI(url)), entity), contentType, handler, context);
    }
    ...
    public RequestHandle post(Context context, String url, Header[] headers, RequestParams params, String contentType,
        ...
        if (params != null) request.setEntity(paramsToEntity(params, handler));
        if (headers != null) request.setHeaders(headers);
        return sendRequest(httpClient, httpContext, request, contentType, handler, context);
    }
    ...
    public RequestHandle post(Context context, String url, Header[] headers, HttpEntity entity, String contentType,
        ...
        if (headers != null) request.setHeaders(headers);
        return sendRequest(httpClient, httpContext, request, contentType, getWrapperResponseHandler(responseHandler), context);
    }
    ...
    private AsyncHttpResponseHandler getWrapperResponseHandler(IResponseHandler responseHandler) {
        AsyncHttpResponseHandler handler;
        if (responseHandler instanceof AsyncHttpResponseHandler) {
            handler = (AsyncHttpResponseHandler) responseHandler;
        } else {
            handler = new AsyncHttpResponseHandler(responseHandler);
        }
        return handler;
    }
