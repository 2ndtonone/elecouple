...
public class AsyncHttpResponseHandler implements ResponseHandlerInterface, IResponseHandler {
    ...
    private IResponseHandler mProxyResponseHandler = null;
    ...
    public AsyncHttpResponseHandler(IResponseHandler proxy) {
        this(Looper.myLooper());
        mProxyResponseHandler = proxy;
    }
    ...
    public void onProgress(long bytesWritten, long totalSize) {
        ...
        if (mProxyResponseHandler != null) {
            mProxyResponseHandler.onProgress(bytesWritten, totalSize);
        }
    }
    ...
    public void onStart(URI requestURI, RequestParams requestParams) {
        ...
        if (mProxyResponseHandler != null) {
            mProxyResponseHandler.onStart(requestURI, requestParams);
        }
    }
    ...
    public void onFinish() {
        // default log warning is not necessary, because this method is just optional notification
        if (mProxyResponseHandler != null) {
            mProxyResponseHandler.onFinish();
        }
    }
    ...
    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
        if (mProxyResponseHandler != null) {
            mProxyResponseHandler.onSuccess(statusCode, headers, responseBody);
        }
    }
    ...
    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
        if (mProxyResponseHandler != null) {
            mProxyResponseHandler.onFailure(statusCode, headers, responseBody, error);
        }
    }
    ...
    public void onRetry(int retryNo) {
        ...
        if (mProxyResponseHandler != null) {
            mProxyResponseHandler.onRetry(retryNo);
        }
    }
    ...
    public void onCancel() {
        ...
        if (mProxyResponseHandler != null) {
            mProxyResponseHandler.onCancel();
        }
    }
        ...
        try {
            switch (message.what) {
                ...
                case FAILURE_MESSAGE:
                    ...
                    break;
                case START_MESSAGE:
                    onStart(requestURI, requestParams);
                    break;
                case FINISH_MESSAGE:
                    onFinish();
                    break;
