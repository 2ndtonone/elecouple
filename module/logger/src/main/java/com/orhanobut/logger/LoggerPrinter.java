...
final class LoggerPrinter implements Printer {
     ...
     *
     * @param contentHeader extra text before json
     * @param json          the json content
     */
    @Override
    public void json(String contentHeader, String json) {
        StringBuilder msgSb = new StringBuilder();
        if (!TextUtils.isEmpty(contentHeader)) {
            msgSb.append(contentHeader + "\n");
            msgSb.append(SINGLE_DIVIDER + SINGLE_DIVIDER + "\n");
        }
        if (TextUtils.isEmpty(json)) {
            msgSb.append("Empty/Null json content");
            d(msgSb.toString());
            return;
        }
        try {
            ...
            msgSb.append("Not valid json" + "\n" + json);
            d(msgSb.toString());
        } catch (JSONException e) {
            msgSb.append(e.getCause().getMessage() + "\n" + json);
            e(msgSb.toString());
        }
    }
