...
//        mRenderer.setChartTitle("自定义折线图");
//        mRenderer.setAxisTitleTextSize(16);
//        mRenderer.setChartTitleTextSize(20);
        mRenderer.setLabelsTextSize(0);// 设置轴标签文本大小
        mRenderer.setLegendTextSize(15);// 设置图例文本大小
        ...
        mRenderer.setShowAxes(false); //设置不显示X,Y轴
        ...
        mNewSeries.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                // renderer.setDisplayChartValuesDistance(0);
